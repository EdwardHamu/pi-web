...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "wallpaper.error.storage": "The image is active for this page but could not be saved in the browser.",
    ...
    "sidebar.pin": "Pin session to top",
    "sidebar.unpin": "Unpin session",
    "sidebar.pinned": "Pinned session",
