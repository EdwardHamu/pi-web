...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "wallpaper.title": "壁紙",
    "wallpaper.default": "預設壁紙",
    "wallpaper.upload": "上傳圖片",
    "wallpaper.reset": "移除自訂壁紙",
    "wallpaper.overlay": "可讀性遮罩（調暗壁紙以提升文字可讀性）",
    "wallpaper.close": "關閉壁紙設定",
    "wallpaper.error.type": "請選擇圖片檔案。",
    "wallpaper.error.size": "圖片大小必須為 20 MB 以下。",
    "wallpaper.error.storage": "圖片已套用於此頁面，但無法儲存至瀏覽器。",
    "history.full": "完整紀錄",
    ...
    "sidebar.pin": "將工作階段置頂",
    "sidebar.unpin": "取消工作階段置頂",
    "sidebar.pinned": "已置頂的工作階段",
